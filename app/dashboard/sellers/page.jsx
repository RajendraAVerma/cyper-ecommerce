    ...
    return <>
        <div className="border rounded w-auto">
            <div className="flex justify-between py-5 px-5">
                <h1 className="font-bold">Seller List View</h1>
    ...
    return (
        <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-[#f3f6f9]">
                <tr>
                    <th className="py-3 px-3 text-left text-[11px] font-bold text-[#878a99] uppercase tracking-wider">Seller Name</th>
                    <th className="py-3 px-3 text-left text-[11px] font-bold text-[#878a99] uppercase tracking-wider">Item Stock</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                {sellers.map((seller) => (
                    <tr key={seller.sellerName}>
                        ...
                        <td className="py-3 px-3 text-[14px] whitespace-nowrap">{seller.itemStock}</td>
